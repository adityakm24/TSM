...
if (is_user_logged_in() && $_COOKIE['id'] != NULL) {
    ...
    if (isset($_POST['submit_student'])) {
        ...
        if (empty($regno)) {
            ...
            $sql = "INSERT INTO tsm_students (school_id, reg_no, uname, dob, mail_id, gender, ph_no, ph_res, age, address_present, address_permanent, informant, religion, mother_tongue, evaluation_date, father_name, mother_name, father_education, mother_education, father_occupation, mother_occupation, annual_family_income, primary_caretaker, reference, created_at) 
        VALUES ('$school_id', '$regno', '$uname', '$dob', '$mail_id', '$gender', '$ph_no', '$ph_res','$age', '$addressp', '$addresspr', '$informant', '$religion', '$mother_tongue', '$eval', '$fname', '$mname', '$fed', '$med', '$focc', '$mocc', '$famincom', '$caretaker', '$referee', current_time())";

            $result = $wpdb->query($sql);
            if ($result) {
                echo '<div class="success-message">Data has been uploaded successfully.</div>';
                wp_redirect(home_url('/admin-dashboard/addstudents'));
                exit;
            } else {
        ...
        if ($roll_no_exists > 1) {
            ...
            $data = array(
                ...
                'ph_no' => $update_ph_no,
                'ph_res' => $update_ph_res,
                'age' => $update_age,
                'address_present' => $update_addresspr,
                'address_permanent' => $update_addressp,
                'informant' => $update_informant,
                'religion' => $update_religion,
                'mother_tongue' => $update_mother_tongue,
                'evaluation_date' => $update_eval,
                'father_name' => $update_fname,
                'mother_name' => $update_mname,
                'father_education' => $update_fed,
                'mother_education' => $update_med,
                'father_occupation' => $update_focc,
                'mother_education' => $update_mocc,
                'annual_family_income' => $update_famincom,
                'primary_caretaker' => $update_caretaker,
                'reference' => $update_referee,
...
?>
    ...
    <div class="container">
        ...
        <!-- Add Student Form -->
        <button onclick="showPopup()">Add Student</button>
        ...
        <div class="popup-overlay" id="editPopupOverlay">
            <div class="popup-container">
                <h2 class="entry-title">Edit Student Data</h2>
                <form method="post" action="">
                    <input type="number" name="update_id" id="update_id" value="">

                    <label for="regno">Reg NO:</label>
                    <input type="number" name="update_regno" id="update_regno" required autocomplete="on" oninput="this.placeholder = this.value">

                    <label for="uname">Name:</label>
                    <input type="text" name="update_uname" id="update_uname" required autocomplete="on" oninput="this.placeholder = this.value">

                    <label for="dob">Date Of Birth:</label>
                    <input type="date" name="dob" id="update_dob" required autocomplete="on" oninput="this.placeholder = this.value">

                    <label for="age">Age:</label>
                    <input type="number" name="age" id="update_age" required autocomplete="on" oninput="this.placeholder = this.value">

                    <label for="gender">Gender:</label>
                    <input type="text" name="gender" id="update_gender" required autocomplete="on" oninput="this.placeholder = this.value">

                    <label for="mail_id">Email:</label>
                    <input type="email" name="update_mail_id" id="update_mail_id" required autocomplete="on" oninput="this.placeholder = this.value">

                    <label for="addresspr">Address Permenent:</label>
                    <textarea name="update_addresspr" id="update_addresspr" required autocomplete="on" oninput="this.placeholder = this.value"></textarea>

                    <label for="addressp">Address Present:</label>
                    <textarea name="update_addressp" id="update_addressp" required autocomplete="on" oninput="this.placeholder = this.value"></textarea>

                    <label for="ph_no">Phone Number:</label>
                    <input type="text" name="update_ph_no" id="update_ph_no" required autocomplete="on" oninput="this.placeholder = this.value">

                    <label for="ph_res">Phone Number (Residential):</label>
                    <input type="text" name="update_ph_res" id="update_ph_res" required autocomplete="on" oninput="this.placeholder = this.value">

                    <label for="informant">Infortmant:</label>
                    <input type="text" name="update_informant" id="update_informant" required autocomplete="on" oninput="this.placeholder = this.value">

                    <label for="religion">Religion:</label>
                    <input type="text" name="update_religion" id="update_religion" required autocomplete="on" oninput="this.placeholder = this.value">

                    <label for="mother_tongue">Mother Tongue:</label>
                    <input type="text" name="update_mother_tongue" id="update_mother_tongue" required autocomplete="on" oninput="this.placeholder = this.value">

                    <label for="eval">Date Of Evaluation:</label>
                    <input type="date" name="update_eval" id="update_eval" required autocomplete="on" oninput="this.placeholder = this.value">

                    <label for="fname">Father's Name:</label>
                    <input type="text" name="update_fname" id="update_fname" required autocomplete="on" oninput="this.placeholder = this.value">

                    <label for="mname">Mother's Name:</label>
                    <input type="text" name="update_mname" id="update_mname" required autocomplete="on" oninput="this.placeholder = this.value">

                    <label for="fed">Father's Education:</label>
                    <input type="text" name="update_fed" id="update_fed" required autocomplete="on" oninput="this.placeholder = this.value">

                    <label for="med">Mother's Education:</label>
                    <input type="text" name="update_med" id="update_med" required autocomplete="on" oninput="this.placeholder = this.value">

                    <label for="focc">Father's Occupation:</label>
                    <input type="text" name="update_focc" id="update_focc" required autocomplete="on" oninput="this.placeholder = this.value">

                    <label for="mocc">Mother's Occupation:</label>
                    <input type="text" name="update_mocc" id="update_mocc" required autocomplete="on" oninput="this.placeholder = this.value">

                    <label for="famincom">Annual Family Income</label>
                    <input type="text" name="update_famincom" id="update_famincom" required autocomplete="on" oninput="this.placeholder = this.value">

                    <label for="caretaker">Primary Care Taker:</label>
                    <input type="text" name="update_caretaker" id="update_caretaker" required autocomplete="on" oninput="this.placeholder = this.value">

                    <label for="referee">Refered By</label>
                    <input type="text" name="update_referee" id="update_referee" required autocomplete="on" oninput="this.placeholder = this.value">
        ...
        <?php if (!empty($query_results)) : ?>
            <table>
                ...
                <tbody>
                    <?php foreach ($query_results as $student_data) : ?>
                        <tr>
                            ...
                            <td>
                                <button onclick="editPopup(<?php echo $student_data->id; ?>, <?php $query_results ?>)">Edit</button><br>
                                <button onclick="editPopup(<?php echo $student_data->id; ?>, <?php $query_results ?>)">View Profile</button>
                                <form method="post" action="">
                                    <input type="hidden" name="delete_id" value="<?php echo $student_data->id; ?>">
    ...
    <script>
        ...
        function editPopup(id) {
            ...
            const selectedStudent = query_results.find((student) => parseInt(student.id) === id);
            console.log("Selected Student Data:", selectedStudent);
            if (selectedStudent) {
                document.getElementById("update_id").value = selectedStudent.id;
                document.getElementById("update_regno").value = selectedStudent.reg_no;
                document.getElementById("update_uname").value = selectedStudent.uname;
                document.getElementById("update_dob").value = selectedStudent.dob;
                document.getElementById("update_age").value = selectedStudent.age;
                document.getElementById("update_mail_id").value = selectedStudent.mail_id;
                document.getElementById("update_gender").value = selectedStudent.gender;
                document.getElementById("update_ph_no").value = selectedStudent.ph_no;
                document.getElementById("update_ph_res").value = selectedStudent.ph_res;
                document.getElementById("update_addresspr").value = selectedStudent.address_present;
                document.getElementById("update_addressp").value = selectedStudent.address_permanent;
                document.getElementById("update_informant").value = selectedStudent.informant;
                document.getElementById("update_religion").value = selectedStudent.religion;
                document.getElementById("update_mother_tongue").value = selectedStudent.mother_tongue;
                document.getElementById("update_eval").value = selectedStudent.evaluation_date;
                document.getElementById("update_fname").value = selectedStudent.father_name;
                document.getElementById("update_mname").value = selectedStudent.mother_name;
                document.getElementById("update_fed").value = selectedStudent.father_education;
                document.getElementById("update_med").value = selectedStudent.mother_education;
                document.getElementById("update_focc").value = selectedStudent.father_occupation;
                document.getElementById("update_mocc").value = selectedStudent.mother_occupation;
                document.getElementById("update_famincom").value = selectedStudent.annual_family_income;
                document.getElementById("update_caretaker").value = selectedStudent.primary_caretaker;
                document.getElementById("update_referee").value = selectedStudent.reference;
            } else {
